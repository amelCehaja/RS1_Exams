...
namespace Ispit_2017_09_11_DotnetCore.EF
{
    public  class MojDBInitializer
    {
        public static void Izvrsi(MojContext _context)
        {
            ...
            _context.Nastavnik.Add(new Nastavnik { ImePrezime = "Nastavnik1" });
            _context.Nastavnik.Add(new Nastavnik { ImePrezime = "Nastavnik2" });
            _context.Nastavnik.Add(new Nastavnik { ImePrezime = "Nastavnik3" });
            _context.Nastavnik.Add(new Nastavnik { ImePrezime = "Nastavnik4" });
